...
title: "การลงโปรแกรม"
layout: single
permalink: /slimevr-docs/install/
...
ขั้นตอนแรก เราจะต้องไปโหลดโปรแกรมที่ Slimevr.dev โดยแนะนำให้ใช้กับฝั่ง PC หรือ Android เพราะว่าในระบบ IOS ไม่สามารถโหลดผ่าน App store โดยตรงได้ (จะต้อง Sideload)
...
{: .notice--info}
ขั้นตอนถัดไปจะเป็นการตั้งค่าการใช้งานครั้งแรก โดยกดคลิกไปที่นี่ได้เลย: [การตั้งค่าครั้งแรก]({% link _pages/slimevr-docs/onboarding/setup-wizard.md %}){: .btn .btn--primary}